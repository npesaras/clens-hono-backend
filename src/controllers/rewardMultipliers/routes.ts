...
const router = new Hono()
  ...
  .get("/reward-multipliers", authenticationMiddleware, getRewardMultipliersController)
  
  // Create a new reward multipliers (requires authentication)
  .post("/reward-multipliers", authenticationMiddleware, createRewardMultipliersController)
  
  // Get a specific reward multipliers by ID (requires authentication)
  .get("/reward-multipliers/:id", authenticationMiddleware, getRewardMultipliersByIdController)
  
  // Delete a reward multipliers (requires authentication)
  .delete("/reward-multipliers/:id", authenticationMiddleware, deleteRewardMultipliersController)
  
  // Update a reward multipliers' information (requires authentication)
  .put("/reward-multipliers/:id", authenticationMiddleware, updateRewardMultipliersController);
