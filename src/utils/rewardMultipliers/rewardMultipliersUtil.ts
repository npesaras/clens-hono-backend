...
export const updateRewardMultipliersSchema = z.object({
    ...
    multiplierExp: z.number().min(0, 'Multiplier exp must be non-negative').optional(),
    multiplierPoints: z.number().min(0, 'Multiplier points must be non-negative').optional()
});

// Types based on schemas
export type CreateRewardMultipliersInput = z.infer<typeof createRewardMultipliersSchema>;
export type UpdateRewardMultipliersInput = z.infer<typeof updateRewardMultipliersSchema>;
